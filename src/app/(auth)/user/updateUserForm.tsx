...
import { BiEdit, BiTrashAlt, BiPlus, BiBrush } from "react-icons/bi"
  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-between'>
        <button
          className='flex justify-center items-center text-md w-2/6 bg-yellow-500  text-white font-bold py-2 px-4 border rounded-md focus:outline-none focus:shadow-outline hover:bg-gray-50 hover:border-yellow-500 hover:text-yellow-500'
          type='submit'
        >
          Atualizar
          <span>
